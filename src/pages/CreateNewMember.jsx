            ...
            >
              ...
              <Row gutter={16}>
                <Col span={12}>
                  ...
                  <Input id= "first_name" style={{ boxSizing: 'border-box', border: '2px solid #A9A9CC', borderRadius: '30px', height: '50px', width: '400px' }} placeholder="First Name" />
                </Col>
                <Col span={12}>
                  <Typography.Text style={{
                    font: 'Poppins',
                  ...
                  <Input  id= "middle_name" style={{ boxSizing: 'border-box', border: '2px solid #A9A9CC', borderRadius: '30px', height: '50px', width: '400px' }} placeholder="Middle Name" />
                </Col>
              </Row>
              <br />
              <Row gutter={16}>
