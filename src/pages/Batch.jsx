...
function Batch() {
    ...
    return (
        ...
        <Col style={{ margin: '10px' }}>
            <Card style={{ width: '1000px',boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.2)', borderRadius: '10px' }}>
        ...
        <Col style={{ margin: '10px' }}>
            {data.length > 0 && <Card style={{ width: '1000px', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.2)', borderRadius: '10px' }}>
